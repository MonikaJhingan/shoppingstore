...
function CardGrid() {
  return (
    <div className='bg-white '>
      {/* <div className='Featured Products font-extrabold text-lg'>Feature</div> */}
      <div className='rounded overflow-hidden justify-items-center h-full w-22 shadow-lg mb-2 grid gap-y-6 gap-x-6 grid-cols-3 sm:grid-cols-4 lg:grid-cols-6 xl:gap-x-8 group relative shadow-l grounded-md py-10'>
        <div className='h-100 w-40 shadow-lg'>
        ...
        <div className='h-100 w-40 shadow-lg'>
          <a href='https://www.giva.com/'>
            {' '}
            <img src={img4} alt='logo' />
          </a>
        </div>
        <div className='h-100 w-40 shadow-lg'>
          <a href='https://www.licious.com/'>
            {' '}
